...
!(function (e, t) {
    ...
    function R(t) {
        ...
        for (const [o, i] of e(t))
            void 0 !== r(t, o) && (Array.isArray(i) ? (n[o] = S(i)) : 'object' == typeof i && i.constructor === Object ? (n[o] = R(i)) : (n[o] = i));
        return n;
    }
    function w(e, t) {
        for (; null !== e; ) {
    ...
    var $ = (function t() {
        ...
        const o = e => t(e);
        if (((o.version = '3.0.7'), (o.removed = []), !n || !n.document || 9 !== n.document.nodeType)) return (o.isSupported = !1), o;
        let { document: r } = n;
        const a = r,
            c = a.currentScript,
            {
        ...
        const { MUSTACHE_EXPR: le, ERB_EXPR: ce, TMPLIT_EXPR: se, DATA_ATTR: ue, ARIA_ATTR: me, IS_SCRIPT_OR_DATA: fe, ATTR_WHITESPACE: pe } = X;
        ...
        const ot = r.createElement('form'),
            ...
            Nt = function e(t) {
                ...
                for (yt('beforeSanitizeShadowDOM', t, null); (n = o.nextNode()); )
                    yt('uponSanitizeShadowNode', n, null), Et(n) || (n.content instanceof s && e(n.content), bt(n));
